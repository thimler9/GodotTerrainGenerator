            ...
            if (diff.X > 0)
            {
                ...
                for (int y = 0; y < 4; y++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        eventQueue.AddEvent(new ChunkIntentEvent(children[0, y, z].Hash, children[0, y, z].Offset, children[0, y, z].Size, children[0, y, z].Lod, children[0, y, z].Depth, ChunkIntentState.Missing));
                    }
                }
            ...
            else if (diff.X < 0)
            {
                ...
                for (int y = 0; y < 4; y++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        eventQueue.AddEvent(new ChunkIntentEvent(children[3, y, z].Hash, children[3, y, z].Offset, children[3, y, z].Size, children[3, y, z].Lod, children[3, y, z].Depth, ChunkIntentState.Missing));
                    }
                }
                ...
                for (int x = 0; x < 4; x++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        if (children[x, 0, z] != null)
                        {
                            ...
                            eventQueue.AddEvent(new ChunkIntentEvent(children[x, 0, z].Hash, children[x, 0, z].Offset, children[x, 0, z].Size, children[x, 0, z].Lod, children[x, 0, z].Depth, ChunkIntentState.Missing));
                        }
                    }
                }
                ...
                for (int x = 0; x < 4; x++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        if (children[x, 3, z] != null)
                        {
                            ...
                            eventQueue.AddEvent(new ChunkIntentEvent(children[x, 3, z].Hash, children[x, 3, z].Offset, children[x, 3, z].Size, children[x, 3, z].Lod, children[x, 3, z].Depth, ChunkIntentState.Missing));
                        }
                    }
                }
                ...
                for (int x = 0; x < 4; x++)
                {
                    for (int y = 0; y < 4; y++)
                    {
                        if (children[x, y, 0] != null)
                        {
                            ...
                            eventQueue.AddEvent(new ChunkIntentEvent(children[x, y, 0].Hash, children[x, y, 0].Offset, children[x, y, 0].Size, children[x, y, 0].Lod, children[x, y, 0].Depth, ChunkIntentState.Missing));
                        }
                    }
                }
                ...
                for (int x = 0; x < 4; x++)
                {
                    for (int y = 0; y < 4; y++)
                    {
                        if (children[x, y, 3] != null)
                        {
                            ...
                            eventQueue.AddEvent(new ChunkIntentEvent(children[x, y, 3].Hash, children[x, y, 3].Offset, children[x, y, 3].Size, children[x, y, 3].Lod, children[x, y, 3].Depth, ChunkIntentState.Missing));
                        }
                    }
                }
